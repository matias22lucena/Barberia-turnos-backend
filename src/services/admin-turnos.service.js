...
export const obtenerTurnosAdmin =
  async ({
    fecha,
    estado,
  }) => {
    ...
    try {
      return await listarTurnosAdmin(
        connection,
        {
          fecha:
            fechaValidada,
...
export const cambiarEstadoTurnoAdmin =
  async ({
    turnoId,
    estado,
  }) => {
    const turnoIdValidado =
      validarTurnoId(
        turnoId
      );
